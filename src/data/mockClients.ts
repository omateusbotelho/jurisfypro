...
export const mockClients: ClientFolder[] = [
  ...
  },
  {
    ...
    files: [
      ...
      { id: "f3e", name: "Ficha do Cliente.docx", type: "doc", size: "102 KB", date: "2026-04-06", description: "Informações cadastrais completas" },
      { id: "f3f", name: "Comprovante de Endereço.pdf", type: "pdf", size: "275 KB", date: "2026-04-07", description: "Comprovante de endereço" },
  ...
  },
  {
    ...
    benefitType: "Aposentadoria por Idade",
    files: [
      { id: "f4a", name: "Contrato de Honorários.pdf", type: "contract", size: "425 KB", date: "2026-04-01", description: "Contrato de honorários advocatícios", fileSrc: "/clients/izete/contrato_honorarios.pdf" },
      { id: "f4b", name: "Procuração.pdf", type: "contract", size: "370 KB", date: "2026-04-02", description: "Procuração ad judicia", fileSrc: "/clients/izete/procuracao.pdf" },
      { id: "f4c", name: "Gravação Atendimento.mp3", type: "audio", size: "5.8 MB", date: "2026-04-03", description: "Áudio da reunião inicial", audioSrc: "/audio/silent_4.wav" },
    ...
    sdrNotes: [
      { sdrName: "Amanda Souza", date: "2026-04-02", channel: "Telefone", clientMood: "tranquilo", summary: "Dona Izete ligou pedindo informações sobre aposentadoria por idade. Tem 59 anos, nascida no Rio de Janeiro mas mora em Betim há muitos anos. Trabalhou como empregada doméstica e diarista. Não usa e-mail, prefere telefone.", notes: ["Trabalhou como doméstica e diarista por décadas", "Parte do período sem registro formal", "Mora em Betim com familiares", "Muito simpática e comunicativa", "Contato apenas por telefone"], nextSteps: "Solicitar CNIS e verificar períodos de contribuição para análise completa" },
    ],
  },
  {
  ...
  },
  {
    ...
    files: [
      ...
      { id: "f6e", name: "Ficha do Cliente.docx", type: "doc", size: "95 KB", date: "2026-04-06", description: "Informações cadastrais completas" },
      { id: "f6f", name: "Comprovante de Endereço.pdf", type: "pdf", size: "260 KB", date: "2026-04-07", description: "Comprovante de endereço" },
  ...
  },
  {
    ...
    sdrNotes: [
      { sdrName: "Lucas Martins", date: "2026-04-03", channel: "Indicação", clientMood: "tranquilo", summary: "Dona Lúcia foi indicada pela cliente Maria Santos. Chegou tranquila e organizada com todos os documentos em uma pasta. Tem 63 anos e contribuiu certinho a vida toda como professora da rede municipal.", notes: ["30 anos como professora municipal", "Documentação toda em dia e organizada", "Quer se aposentar para cuidar dos netos", "Muito simpática, trouxe bolo para o escritório"], nextSteps: "Análise rápida do CNIS e protocolar requerimento - caso simples e bem documentado" },
    ],
  },
  {
  ...
  },
  {
    ...
    sdrNotes: [
      { sdrName: "Lucas Martins", date: "2026-04-08", channel: "WhatsApp", clientMood: "urgente", summary: "A esposa do Paulo mandou mensagem porque ele não consegue mais mexer no celular direito. Ele teve um AVC há 4 meses e ficou com sequelas no lado esquerdo do corpo. Está no auxílio-doença mas a perícia está chegando e eles têm medo de perder.", notes: ["AVC isquêmico com hemiparesia esquerda", "Era segurança patrimonial, função exige esforço físico", "Não tem condições de voltar a trabalhar em nenhuma função", "Esposa largou o emprego para cuidar dele", "Precisam converter auxílio-doença em aposentadoria por invalidez"], nextSteps: "Reunir laudos neurológicos atualizados e preparar pedido de conversão com relatório de impossibilidade de reabilitação" },
    ],
  },
  {
