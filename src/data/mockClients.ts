...
export const mockClients: ClientFolder[] = [
  ...
  },
  {
    ...
    files: [...baseFiles(2, "2026-01-10"), { id: "f2h", name: "Sentença Favorável.pdf", type: "pdf", size: "1.2 MB", date: "2026-06-20", description: "Sentença do processo - deferido" }],
    sdrNotes: [
      { sdrName: "Amanda Souza", date: "2026-01-09", channel: "Telefone", clientMood: "decidido", summary: "Seu José ligou já decidido a contratar. Disse que pesquisou bastante na internet e escolheu nosso escritório pelas avaliações no Google. Tem 35 anos de contribuição e quer saber qual a melhor regra de transição.", notes: ["Cliente muito bem informado sobre as regras de transição", "Trabalhou a vida inteira em metalúrgica", "Tem todos os documentos digitalizados no celular", "Quer resolver o mais rápido possível para poder viajar com a esposa"], nextSteps: "Fazer simulação completa com todas as regras de transição e apresentar a mais vantajosa" },
    ],
  },
  {
  ...
  },
  {
    ...
    files: [...baseFiles(5, "2026-02-14"), { id: "f5h", name: "Certidão de Óbito.pdf", type: "pdf", size: "520 KB", date: "2026-02-15", description: "Certidão de óbito do segurado" }],
    sdrNotes: [
      { sdrName: "Amanda Souza", date: "2026-02-12", channel: "Telefone", clientMood: "emotivo", summary: "Dona Francisca ligou chorando muito. O marido faleceu há 3 semanas e ela não sabe o que fazer. Uma amiga da igreja indicou o escritório. Ela nunca trabalhou fora e dependia totalmente do marido.", notes: ["Marido era aposentado por tempo de contribuição", "Casados há 38 anos com certidão", "Dona Francisca tem 64 anos e nunca contribuiu", "Está morando com a filha temporariamente", "Precisa de muito acolhimento emocional"], nextSteps: "Agendar reunião com calma, pedir que traga certidão de óbito, casamento e documentos do marido" },
    ],
  },
  {
  ...
  },
  {
    ...
    benefitType: "Aposentadoria por Incapacidade Permanente",
    files: [...baseFiles(16, "2026-08-22"), { id: "f16h", name: "Laudo Neurológico.pdf", type: "pdf", size: "950 KB", date: "2026-08-25", description: "Laudo médico neurológico" }],
    sdrNotes: [
      { sdrName: "Lucas Martins", date: "2026-08-20", channel: "WhatsApp", clientMood: "urgente", summary: "A esposa do Paulo mandou mensagem porque ele não consegue mais mexer no celular direito. Ele teve um AVC há 4 meses e ficou com sequelas no lado esquerdo do corpo. Está no auxílio-doença mas a perícia está chegando e eles têm medo de perder.", notes: ["AVC isquêmico com hemiparesia esquerda", "Era segurança patrimonial, função exige esforço físico", "Não tem condições de voltar a trabalhar em nenhuma função", "Esposa largou o emprego para cuidar dele", "Precisam converter auxílio-doença em aposentadoria por invalidez"], nextSteps: "Reunir laudos neurológicos atualizados e preparar pedido de conversão com relatório de impossibilidade de reabilitação" },
    ],
  },
  {
