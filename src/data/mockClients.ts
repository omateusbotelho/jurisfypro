...
export const mockClients: ClientFolder[] = [
  {
    ...
    contractType: "Aposentadoria por Idade", status: "concluido", createdAt: "2026-03-21",
    phone: "(81) 99872-3415 / (81) 99634-7821", email: "rainis.lejins@email.com", address: "Limoeiro - PE",
    benefitType: "Aposentadoria por Idade",
    files: [
      { id: "f1a", name: "Contrato de Honorários.pdf", type: "contract", size: "312 KB", date: "2026-03-23", description: "Contrato de honorários advocatícios", fileSrc: "/clients/rainis/contrato_honorarios.pdf" },
      { id: "f1b", name: "Procuração.pdf", type: "contract", size: "245 KB", date: "2026-03-23", description: "Procuração ad judicia", fileSrc: "/clients/rainis/procuracao.pdf" },
      { id: "f1c", name: "Gravação Atendimento.mp3", type: "audio", size: "4.2 MB", date: "2026-03-22", description: "Áudio da reunião inicial" },
      { id: "f1d", name: "Documento - Frente.jpg", type: "photo", size: "1.4 MB", date: "2026-03-23", description: "Documento de identidade - frente", fileSrc: "/clients/rainis/rg_frente.jpg" },
      { id: "f1e", name: "Documento - Verso.jpg", type: "photo", size: "1.1 MB", date: "2026-03-23", description: "Documento de identidade - verso", fileSrc: "/clients/rainis/rg_verso.jpg" },
    ...
    sdrNotes: [
      ...
      { sdrName: "Lucas Martins", date: "2026-03-22", channel: "Presencial", clientMood: "decidido", summary: "Seu Rainis compareceu ao escritório com todos os documentos organizados. Contrato e procuração assinados no mesmo dia. Cliente demonstrou confiança no processo.", notes: ["Apresentou RG/CNH e documentos complementares", "Contrato de honorários e procuração assinados", "Cliente bastante colaborativo e organizado", "Foto da fachada da residência registrada para comprovação"], nextSteps: "Solicitar CNIS detalhado e dar entrada no requerimento administrativo" },
    ],
  },
  {
    id: "2", clientName: "Dijanira da Silva Martins", cpf: "086.444.838-46",
    contractType: "Aposentadoria por Idade", status: "concluido", createdAt: "2026-03-22",
    phone: "(83) 99871-4523 / (83) 99645-3187", email: "dijanira.martins@email.com", address: "Campina Grande - PB",
    benefitType: "Aposentadoria por Idade",
    files: [
      { id: "f2a", name: "Contrato de Honorários.pdf", type: "contract", size: "410 KB", date: "2026-03-22", description: "Contrato de honorários advocatícios", fileSrc: "/clients/dijanira/contrato_honorarios.pdf" },
      { id: "f2b", name: "Procuração.pdf", type: "contract", size: "380 KB", date: "2026-03-22", description: "Procuração ad judicia", fileSrc: "/clients/dijanira/procuracao.pdf" },
      { id: "f2c", name: "Gravação Atendimento.mp3", type: "audio", size: "4.7 MB", date: "2026-03-22", description: "Áudio da reunião inicial", audioSrc: "/audio/silent_2.wav" },
      { id: "f2d", name: "Documento.png", type: "photo", size: "1.8 MB", date: "2026-03-22", description: "Documento de identidade - frente e verso", fileSrc: "/clients/dijanira/documento.png" },
  ...
  },
  {
    ...
    benefitType: "Aposentadoria por Idade",
    files: [
      { id: "f3a", name: "Contrato de Honorários.pdf", type: "contract", size: "395 KB", date: "2026-03-23", description: "Contrato de honorários advocatícios", fileSrc: "/clients/joao/contrato_honorarios.pdf" },
      { id: "f3b", name: "Procuração.pdf", type: "contract", size: "360 KB", date: "2026-03-23", description: "Procuração ad judicia", fileSrc: "/clients/joao/procuracao.pdf" },
      { id: "f3c", name: "Gravação Atendimento.mp3", type: "audio", size: "5.1 MB", date: "2026-03-23", description: "Áudio da reunião inicial", audioSrc: "/audio/silent_3.wav" },
      { id: "f3d", name: "Documento.png", type: "photo", size: "1.6 MB", date: "2026-03-23", description: "CNH - Carteira Nacional de Habilitação", fileSrc: "/clients/joao/documento.png" },
      { id: "f3g", name: "Selfie com Documento.png", type: "photo", size: "2.1 MB", date: "2026-03-23", description: "Selfie segurando o documento", fileSrc: "/clients/joao/selfie_documento.png" },
  ...
  },
  {
    ...
    benefitType: "Aposentadoria por Idade",
    files: [
      { id: "f4a", name: "Contrato de Honorários.pdf", type: "contract", size: "425 KB", date: "2026-03-24", description: "Contrato de honorários advocatícios", fileSrc: "/clients/izete/contrato_honorarios.pdf" },
      { id: "f4b", name: "Procuração.pdf", type: "contract", size: "370 KB", date: "2026-03-24", description: "Procuração ad judicia", fileSrc: "/clients/izete/procuracao.pdf" },
      { id: "f4c", name: "Gravação Atendimento.mp3", type: "audio", size: "5.8 MB", date: "2026-03-24", description: "Áudio da reunião inicial", audioSrc: "/audio/silent_4.wav" },
      { id: "f4d", name: "Documento.png", type: "photo", size: "1.5 MB", date: "2026-03-24", description: "Documento de identidade - frente", fileSrc: "/clients/izete/documento.png" },
      { id: "f4e", name: "Selfie com Documento.png", type: "photo", size: "1.9 MB", date: "2026-03-24", description: "Selfie segurando o documento", fileSrc: "/clients/izete/selfie_documento.png" },
  ...
  },
  {
    ...
    benefitType: "Aposentadoria por Idade",
    files: [
      { id: "f5a", name: "Contrato de Honorários.pdf", type: "contract", size: "405 KB", date: "2026-03-25", description: "Contrato de honorários advocatícios", fileSrc: "/clients/maria/contrato_honorarios.pdf" },
      { id: "f5b", name: "Procuração.pdf", type: "contract", size: "345 KB", date: "2026-03-25", description: "Procuração ad judicia", fileSrc: "/clients/maria/procuracao.pdf" },
      { id: "f5c", name: "Gravação Atendimento.mp3", type: "audio", size: "4.9 MB", date: "2026-03-25", description: "Áudio da reunião inicial", audioSrc: "/audio/silent_5.wav" },
      { id: "f5d", name: "Documento - Frente.png", type: "photo", size: "1.3 MB", date: "2026-03-25", description: "Documento de identidade - frente", fileSrc: "/clients/maria/documento_frente.png" },
      { id: "f5e", name: "Documento - Verso.png", type: "photo", size: "1.2 MB", date: "2026-03-25", description: "Documento de identidade - verso", fileSrc: "/clients/maria/documento_verso.png" },
      { id: "f5f", name: "Selfie com Documento.png", type: "photo", size: "1.7 MB", date: "2026-03-25", description: "Selfie segurando o documento", fileSrc: "/clients/maria/selfie_documento.png" },
  ...
  },
  {
    ...
    benefitType: "Aposentadoria por Idade",
    files: [
      { id: "f6a", name: "Contrato de Honorários.pdf", type: "contract", size: "410 KB", date: "2026-03-22", description: "Contrato de honorários advocatícios", fileSrc: "/clients/jose/contrato_honorarios.pdf" },
      { id: "f6b", name: "Procuração.pdf", type: "contract", size: "345 KB", date: "2026-03-22", description: "Procuração ad judicia", fileSrc: "/clients/jose/procuracao.pdf" },
      { id: "f6c", name: "Gravação Atendimento.mp3", type: "audio", size: "4.7 MB", date: "2026-03-22", description: "Áudio da reunião inicial", audioSrc: "/audio/silent_6.wav" },
  ...
  },
  {
    ...
    benefitType: "Aposentadoria por Idade",
    files: [...baseFiles(7, "2026-03-22"), { id: "f7h", name: "CNIS.pdf", type: "pdf", size: "340 KB", date: "2026-03-22", description: "Cadastro Nacional de Informações Sociais" }],
    sdrNotes: [
      { sdrName: "Lucas Martins", date: "2026-03-22", channel: "Indicação", clientMood: "tranquilo", summary: "Dona Lúcia foi indicada pela cliente Maria Santos. Chegou tranquila e organizada com todos os documentos em uma pasta. Tem 63 anos e contribuiu certinho a vida toda como professora da rede municipal.", notes: ["30 anos como professora municipal", "Documentação toda em dia e organizada", "Quer se aposentar para cuidar dos netos", "Muito simpática, trouxe bolo para o escritório"], nextSteps: "Análise rápida do CNIS e protocolar requerimento - caso simples e bem documentado" },
    ],
  },
  {
  ...
  },
  {
    ...
    benefitType: "Aposentadoria por Idade",
    files: [...baseFiles(11, "2026-03-14"), { id: "f11h", name: "Certidão de Casamento.jpg", type: "photo", size: "1.4 MB", date: "2026-03-22", description: "Certidão de casamento" }],
    sdrNotes: [
  ...
  },
  {
    ...
    benefitType: "Benefício de Prestação Continuada",
    files: [...baseFiles(15, "2026-03-16"), { id: "f15h", name: "Decisão INSS.pdf", type: "pdf", size: "780 KB", date: "2026-03-22", description: "Decisão administrativa - Deferido" }],
    sdrNotes: [
      { sdrName: "Beatriz Lima", date: "2026-03-23", channel: "Presencial", clientMood: "emotivo", summary: "Dona Teresa veio ao escritório sem agendar, caminhando com dificuldade por causa da artrose nos joelhos. Tem 67 anos, nunca contribuiu e vive com a aposentadoria mínima do marido que mal dá pra pagar as contas. Ouviu no rádio que idoso de baixa renda tem direito.", notes: ["Artrose severa nos dois joelhos, usa bengala", "Marido recebe um salário mínimo de aposentadoria", "Moram em casa alugada no valor de R$600", "Nunca trabalhou formalmente", "Muito humilde e educada, pediu desculpa por vir sem agendar"], nextSteps: "Caso clássico de BPC idoso, montar processo com urgência dado a situação de vulnerabilidade" },
    ],
  },
  {
    ...
    benefitType: "Aposentadoria por Idade",
    files: [...baseFiles(16, "2026-03-06"), { id: "f16h", name: "Laudo Neurológico.pdf", type: "pdf", size: "950 KB", date: "2026-03-23", description: "Laudo médico neurológico" }],
    sdrNotes: [
      { sdrName: "Lucas Martins", date: "2026-03-25", channel: "WhatsApp", clientMood: "urgente", summary: "A esposa do Paulo mandou mensagem porque ele não consegue mais mexer no celular direito. Ele teve um AVC há 4 meses e ficou com sequelas no lado esquerdo do corpo. Está no auxílio-doença mas a perícia está chegando e eles têm medo de perder.", notes: ["AVC isquêmico com hemiparesia esquerda", "Era segurança patrimonial, função exige esforço físico", "Não tem condições de voltar a trabalhar em nenhuma função", "Esposa largou o emprego para cuidar dele", "Precisam converter auxílio-doença em aposentadoria por invalidez"], nextSteps: "Reunir laudos neurológicos atualizados e preparar pedido de conversão com relatório de impossibilidade de reabilitação" },
    ],
  },
  {
